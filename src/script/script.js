...
const popupVideoplayer = document.querySelector(".start-screen__popup-videoplayer");
...
const recallLink = document.querySelector(".recall__btn");
...
const swiperServices = new Swiper('.slider-services__swiper', {
    ...
    slidesPerView: mobileWidth < 510 ? 1.2 : "auto",
    initialSlide: mobileWidth < 510 ? 0 : 1,
  });

  console.log(swiperServices.width);
